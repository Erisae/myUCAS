...
void screen_write_ch(char ch)
{
    ...
    if (ch == '\n')
    {
        screen_cursor_x[core] = 0;
        screen_cursor_y[core]++;
    }
    else if (ch == 8) // backspace
    {
        if (screen_cursor_x[core] > 0)
        {
            screen_cursor_x[core]--;
            new_screen[screen_cursor_y[core] * SCREEN_WIDTH + screen_cursor_x[core]] = ' ';
        }
    }
    else if (ch == 13) // enter
    {
    ...
    {
        new_screen[screen_cursor_y[core] * SCREEN_WIDTH + screen_cursor_x[core]] = ch;
        screen_cursor_x[core]++;
    }
    ...
    if (screen_cursor_x[core] >= SCREEN_WIDTH)
    {
        screen_cursor_y[core]++;
        screen_cursor_x[core] = 0;
    }

    if (screen_cursor_y[core] < 0)
    {
        screen_cursor_y[core] = 0;
    }

    if (screen_cursor_y[core] >= SCREEN_HEIGHT)
    {
        screen_scroll(SCREEN_HEIGHT / 2 + 1, SCREEN_HEIGHT - 1);
        screen_cursor_x[core] = 0;
        screen_cursor_y[core] = SCREEN_HEIGHT - 1;
    }
    screen_reflush();
}
...
void screen_move_cursor(int x, int y)
{
    int core;
    core = get_cp0_prid();
    screen_cursor_x[core] = x;
    screen_cursor_y[core] = y;
}
...
void screen_reflush(void)
{
    ...
    vt100_move_cursor(screen_cursor_x[core], screen_cursor_y[core]);
}
