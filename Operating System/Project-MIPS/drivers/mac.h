...
#define SEND_BUFF_ADDR 0x40000000
#define RECV_BUFF_ADDR 0x40010000
#define PSIZE (32)
#define PNUM (16) // 描述符
#define PALL (32) //收发包
//#define SEND_ADDR 0xffffffffa1000000
//#define RECV_ADDR 0xffffffffa1001000

//P5任务书中 中断控制寄存器地址中的基址是0xffff ffff a000 0000
#define INT_BASE 0xffffffffa0000000 
#define INTISR_OFFSET 0x1fe11420//RO
#define INTEN_OFFSET 0x1fe11424      //RO
#define INTENSET_OFFSET 0x1fe11428   //WO
#define INTENCLR_OFFSET 0x1fe1142c  //WO
#define INTPOL_OFFSET 0x1fe11430    //WR
#define INTEDGE_OFFSET 0x1fe11434   //WR
#define INTBOUNCE_OFFSET 0x1fe11438 //WO
#define INTAUTO_OFFSET 0x1fe1143c   //WO
...
void do_net_send(uint64_t buf_addr, uint64_t size);
